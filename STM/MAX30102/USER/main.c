...
{ 
	...
	//printf("\r\n MAX30102  init  \r\n");
	 ...
	 printf("AT+MQTTUSERCFG=0,1,\"\",\"Mqtt_stm32&k10gfhbhcR0\",\"ee1173cd937193e4eaa722ed6c75f91d01f9844eddd6159bedb1a0322f080f0e\",0,0,\"\"\r\n");
	 delay_ms1(3000);
	 printf("AT+MQTTCLIENTID=0,\"k10gfhbhcR0.Mqtt_stm32|securemode=2\\,signmethod=hmacsha256\\,timestamp=1712932756099|\"\r\n");
	 delay_ms1(3000);
...
/*			
			printf("AT+MQTTPUB=0,"
       "\"/sys/k10gfhbhcR0/Mqtt_stm32/thing/event/property/post\","
       "\"{\\\"id\\\":\\\"123\\\","
       "\\\"version\\\":\\\"1.0\\\","
       "\\\"params\\\":{"
       "\\\"temp\\\":%.2f,"
